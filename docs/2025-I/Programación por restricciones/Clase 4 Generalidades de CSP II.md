...
![Notas1_annotated.pdf](Clase%204%20Generalidades%20de%20CSP%20II/Notas1_annotated.pdf){ type=application/pdf style="min-height:70vh;width:100%"}
...
![split2.pdf](Clase%204%20Generalidades%20de%20CSP%20II/split2.pdf){ type=application/pdf style="min-height:70vh;width:100%"}
...
![splitbi.pdf](Clase%204%20Generalidades%20de%20CSP%20II/splitbi.pdf){ type=application/pdf style="min-height:70vh;width:100%"}
...
![split3.pdf](Clase%204%20Generalidades%20de%20CSP%20II/split3.pdf){ type=application/pdf style="min-height:70vh;width:100%"}
...
![split4.pdf](Clase%204%20Generalidades%20de%20CSP%20II/split4.pdf){ type=application/pdf style="min-height:70vh;width:100%"}
...
![split5.pdf](Clase%204%20Generalidades%20de%20CSP%20II/split5.pdf){ type=application/pdf style="min-height:70vh;width:100%"}
