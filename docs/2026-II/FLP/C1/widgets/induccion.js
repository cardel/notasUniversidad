...
var BLOQUES = (function () {
  ...
  return [
    {
      id: "listaint",
      opciones: ["Pertenece", "No pertenece"],
    ...
    {
      id: "llamada",
      opciones: ["La autoriza", "No la autoriza"],
