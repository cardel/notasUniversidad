...
Las cuatro formas de guardar un grafo y cómo se construye cada una, con lo que
ocupa y lo que cuesta consultarla. De ahí sale cuál conviene, y de ahí la
pregunta que viene después: cómo se recorre un grafo, en profundidad y en
amplitud.
...
[definiciones y familias de grafos](../C5/Introduccion%20a%20grafos.md), que
son la base de todo lo que sigue.
