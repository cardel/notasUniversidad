...
1. Entender el concepto de ligadura local atada al alcance léxico
2. Entender cómo funcionan los condicionales
3. Entender el concepto de procedimientos
	1. Entender el concepto de clausura
	2. Entender como se evaluan los procedimientos
...
1. Implementamos los condicionales, para esto usamos la evaluación de una condición y ejecución condicional de dos expresiones
2. Implementamos las ligaduras locales, estas extienden actual, tienen dos areas
	1. Area de definiciones: Actua el ambiente actual
	2. Area de expresión (despues del in) actual el nuevo ambiente que extiende del actual
3. Procedimientos
	1. Creación de clausuras para garantizar consistencia y determinismo
		1. lid Argumentos
		2. exp Cuerpo del procedimiento
		3. old-env ambiente donde se crea el procedimiento
	2. Implementación su creación (proc)
	3. Implementación su evaluación
		1. Se crea un ambiente extendido con lid de la clausura y los valores que mandamos
		2. Este ambiente extiende del ambiente almacenado en la clausura