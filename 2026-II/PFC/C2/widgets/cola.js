...
(function () {
  var VARIANTES = [
    { id: "a", deCola: true,
      ...
      porque: "La llamada es lo último que hace el cuerpo. No hay nada alrededor esperando su resultado." },
    { id: "b", deCola: false,
      codigo: "def factIter(cont: Int, prod: Int, n: Int): Int =\n  if (cont > n) prod\n  else 1 + factIter(cont + 1, cont * prod, n) - 1",
      en6: "720", en100000: "StackOverflowError",
      porque: "El 1 + ... - 1 no cambia el valor, pero la suma tiene que esperar a que la llamada vuelva. Cada vuelta deja un marco en la pila." },
    { id: "c", deCola: false,
      codigo: "def factIter(cont: Int, prod: Int, n: Int): Int =\n  if (cont > n) prod\n  else factIter(cont + 1, prod, n) * cont",
      en6: "720", en100000: "StackOverflowError",
      porque: "La multiplicación por cont se hace después de que la llamada vuelve. Es factorial lineal disfrazada de factIter: prod nunca cambia." },
    { id: "d", deCola: false,
      codigo: "def factIter(cont: Int, prod: Int, n: Int): Int =\n  if (cont > n) prod\n  else math.max(factIter(cont + 1, cont * prod, n), 0)",
      en6: "720", en100000: "StackOverflowError",
      porque: "La llamada está dentro del argumento de math.max, así que math.max espera. Envolver la llamada en cualquier función la saca de la cola." },
    { id: "e", deCola: true,
      codigo: "def factIter(cont: Int, prod: Int, n: Int): Int =\n  if (cont > n) prod\n  else {\n    val p = cont * prod\n    factIter(cont + 1, p, n)\n  }",
      en6: "720", en100000: "0 (termina)",
      porque: "El val se calcula antes de llamar, y la llamada sigue siendo lo último. Un bloque con definiciones no rompe la cola: lo que la rompe es una operación pendiente después de la llamada." }
  ];
